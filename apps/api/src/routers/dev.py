...
@router.get(
    "/config",
    summary="Get BestDevs LMS runtime config",
    description="Returns the current BestDevs LMS configuration with sensitive values redacted. Restricted to superadmin users.",
    responses={
