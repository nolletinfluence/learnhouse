  ...
  return createPortal(
    <>
      ...
      >
        ...
        >
          {/* BestDevs LMS logo — links to home */}
          <Link
            href="/dash"
          ...
          >
            <img
              ...
              alt="BestDevs LMS"
              className="h-[18px] w-[18px] rounded opacity-80 hover:opacity-100 transition-opacity"
            />
          </Link>
              ...
              <div className="flex items-center gap-3 px-4 py-3.5">
                {planMeetsRequirement(plan, 'standard') && org?.logo_image ? (
                  ...
                  <div className="h-7 w-7 flex items-center justify-center bg-white/[0.06] rounded-lg">
                    <img src="/bestdevs-icon.png" alt="BestDevs LMS" className="h-4 w-4 rounded" />
                  </div>
                )}
