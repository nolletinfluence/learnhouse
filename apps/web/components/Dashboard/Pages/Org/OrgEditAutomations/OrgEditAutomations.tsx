...
const OrgEditAutomations: React.FC = () => {
  ...
  // Zapier hero card stays hidden until the BestDevs LMS Zapier app is live
  const showZapierHeroCard = false

  return (
    <FeatureGate feature="webhooks">
      <>
        {/* ── Zapier hero card (hidden until the BestDevs LMS Zapier app is live) ────────────────────── */}
        {showZapierHeroCard && (
          ...
          <div className="px-5 py-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-500 text-xs mt-0.5">
                Connect BestDevs LMS to thousands of apps without writing code.
              </p>
            </div>
...
// Zapier-managed webhooks are read-only from BestDevs LMS's side — the Zap itself
